    ...
    <div class="container">
      <section class="product-section">
        <div class="row p-4">
          ...
          <div class="col-lg-6">
            <!-- Product Title -->
            <h1 class="product-title">Cushion Cover</h1>
          ...
          <div class="tab-content" id="productTabsContent">
            ...
            >
              <div class="mt-4">
                ...
                <p class="mb-3">
                  Experience the ultimate in luxury and comfort with our 22mm
                  Mulberry Silk Basic Men's Shirt. Crafted from the finest Grade
                  A silk, this shirt offers unparalleled softness,
                  breathability, and elegance.
                </p>
                <p class="mb-3">
                  The natural properties of mulberry silk make this shirt
                  perfect for all seasons - it keeps you cool in summer and warm
                  in winter. The smooth texture is gentle on your skin and helps
                  maintain your natural moisture balance.
                </p>
                <p>
                  Featuring a classic fit with modern tailoring, this versatile
                  shirt transitions seamlessly from business meetings to casual
                  outings. The refined finish and attention to detail make it a
                  wardrobe essential for the discerning gentleman.
                </p>
              </div>
            </div>
