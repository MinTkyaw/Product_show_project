        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="sizes[]" value="Single" id="option1">
                    <label class="form-check-label" for="option1">Single</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="sizes[]" value="Double" id="option2">
                    <label class="form-check-label" for="option2">Double</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="sizes[]" value="Queen" id="option3">
                    <label class="form-check-label" for="option3">Queen</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="sizes[]" value="King" id="option1">
                    <label class="form-check-label" for="option1">King</label>
                </div>
            </div>
                    ...
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" name="weave[]" class="form-control"></td>
                                <td><input type="text" name="thredcount[]" class="form-control"></td>
