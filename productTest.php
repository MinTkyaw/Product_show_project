        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-2 mb-md-3">
                <div class="col-xl-9 col-xxl-8">
                    ...
                    <p class="mb-0" data-aos="zoom-in">
                        ...
                        Designed for comfort and crafted with care, these pieces are perfect for casual outings,
                        workdays, or relaxed evenings.
                    </p>
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="card card-body bg-primary text-white">
                            Explore our silk collection — crafted with rich textures and elegant designs, perfect for
                            special occasions or when you want to feel truly exquisite.<br />
            ...
            <div class="dropdown mb-5 d-inline-block">
                <a class="btn btn-primary dropdown-toggle" href="#" role="button" data-aos="fade-up"
                    data-bs-toggle="dropdown" aria-expanded="false">Types</a>
            ...
            <div class="row g-4">
                ...
                <a href="OneSet1.php" class="col-md-4 mb-lg-0 mt-0 card-group clothing">
                    <div class="card text-white border-0 justify-content-end position-relative" data-aos="zoom-in-up">
                        ...
                        <div class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark" style="--bs-bg-opacity: 0.3">
                            <h5 class="fw-bold">
                                <?= getProductName($cardProducts['one_set_ready'], 'One Set (Ready Made)') ?></h5>
                        </div>
                    </div>
                </a>
                ...
                <a href="singleBedsheet.php" class="col-md-4 mb-lg-0 mt-0 card-group bedding d-none d-block">
                    <div class="card text-white border-0 justify-content-end position-relative" data-aos="zoom-in-up">
                        ...
                        <div class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark" style="--bs-bg-opacity: 0.3">
                            <h5 class="fw-bold">
                                <?= getProductName($cardProducts['single_bedsheet'], 'Single Bedsheet') ?></h5>
                        </div>
                    </div>
                </a>
                ...
                <a href="doubleBedsheet.php" class="col-md-4 mb-lg-0 mt-0 card-group bedding d-none d-block">
                    <div class="card text-white border-0 justify-content-end position-relative" data-aos="zoom-in-up">
                        ...
                        <div class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark" style="--bs-bg-opacity: 0.3">
                            <h5 class="fw-bold">
                                <?= getProductName($cardProducts['double_bedsheet'], 'Double Bedsheet') ?></h5>
                        </div>
                    </div>
                </a>
