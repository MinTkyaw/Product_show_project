            ...
            <div class="color-options d-flex gap-3 flex-wrap">
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Crimson"
                  title="Crimson" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Crimson
                </small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  src="img/bedding/blanket2.webp"
                  data-color="Dark Slate"
                  data-image="img/bedding/blanket2.webp"
                  data-zoom-image="img/bedding/blanket2.webp"
                  alt="Dark Slate"
                  title="DarkSlate" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Dark Slate</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  src="img/bedding/blanket3.webp"
                  data-color="Pale Rose"
                  data-image="img/bedding/blanket3.webp"
                  data-zoom-image="img/bedding/blanket3.webp"
                  alt="Pale Rose"
                  title="PaleRose" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Pale Rose</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  src="img/bedding/blanket4.webp"
                  data-color="Indigo"
                  data-image="img/bedding/blanket4.webp"
                  data-zoom-image="img/bedding/blanket4.webp"
                  alt="Indigo"
                  title="Indigo" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Indigo</small>
              </div>
            </div>
            <div class="selected-color mt-3">
              <span class="text-tertiary-custom">Selected: </span>
              <span class="text-primary-custom fw-bold" id="selectedColor">Crimson</span>
            </div>
          </div>
