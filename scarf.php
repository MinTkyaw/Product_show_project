            ...
            <div class="color-options d-flex gap-3 flex-wrap">
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Rosy Brown"
                  title="RosyBrown"></img>
                <small class="color-name mt-1 d-block text-tertiary-custom">Rosy Brown</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  ...
                  alt="Floral Motifs"
                  title="FloralMotifs"></img>
                <small class="color-name mt-1 d-block text-tertiary-custom">Floral Motifs</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  ...
                  alt="Art"
                  title="Art"></img>
                <small class="color-name mt-1 d-block text-tertiary-custom">Art</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  ...
                  alt="Mahout"
                  title="Mahout"></img>
                <small class="color-name mt-1 d-block text-tertiary-custom">Mahout
                </small>
              </div>
            </div>
            <div class="selected-color mt-3">
              <span class="text-tertiary-custom">Selected: </span>
              <span class="text-primary-custom fw-bold" id="selectedColor">Rosy Brown</span>
            </div>
          </div>
