            ...
            <div class="color-options d-flex gap-3 flex-wrap">
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Slate Gray"
                  title="Slate Gray" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Slate Gray</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option"
                  ...
                  alt="Mist"
                  title="Mist" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Mist
                </small>
              </div>
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Taupe"
                  title="Taupe" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Taupe
                </small>
              </div>
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Teal"
                  title="Teal" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Teal
                </small>
              </div>
            </div>
            <div class="selected-color mt-3">
              <span class="text-tertiary-custom">Selected: </span>
              <span class="text-primary-custom fw-bold" id="selectedColor">Slate Gray</span>
            </div>
          </div>
