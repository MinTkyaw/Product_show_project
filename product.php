        ...
        <ul class="dropdown-menu">
          <li>
            <a
              ...
              data-i18n="product_type_clothing"
              >Clothing</a>
          </li>
          <li>
            <a
      ...
      <div class="row g-4">
        ...
        <a href="Menwear.php" class="col-md-4 mb-lg-0 mt-0 card-group clothing">
          <div
            ...
            <div class="ratio ratio-1x1">
              <img class="img-fluid object-fit-cover" src="img/clothing/paso1.webp" />
            </div>
            <div
              class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark"
              style="--bs-bg-opacity: 0.3">
              <h5 class="fw-bold">Longyi(Men)</h5>
            </div>
          </div>
        </a>
        ...
        <a href="OneSet1.php" class="col-md-4 mb-lg-0 mt-0 card-group clothing">
          <div
            ...
            data-aos="zoom-in-up">
            <div class="ratio ratio-1x1">
              <img class="img-fluid object-fit-cover" src="img/clothing/oneSet1.jpg" />
            </div>
            <div
              class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark"
              style="--bs-bg-opacity: 0.3">
              <h5 class="fw-bold">One Set(ready made)</h5>
            </div>
          </div>
        </a>
        <a href="OneSet2.php" class="col-md-4 mb-lg-0 mt-0 card-group clothing">
          <div
            ...
            data-aos="zoom-in-up">
            <div class="ratio ratio-1x1">
              <img class="img-fluid object-fit-cover" src="img/clothing/oneSet5.jpg" />
            </div>
            <div
              class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark"
              style="--bs-bg-opacity: 0.3">
              <h5 class="fw-bold">One Set</h5>
            </div>
          </div>
        </a>
        <!-- Bedding -->
        ...
        <a
          ...
          <div
            ...
            <div
              class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark"
              style="--bs-bg-opacity: 0.3">
              <h5 class="fw-bold">Single Bedsheet</h5>
              <!-- <div>Programmer</div> -->
            </div>
          </div>
        </a>
        <a
          ...
          <div
            ...
            <div
              class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark"
              style="--bs-bg-opacity: 0.3">
              <h5 class="fw-bold">Double Bedsheet</h5>
              <!-- <div>Programmer</div> -->
            </div>
          </div>
        </a>
        ...
        <a
          ...
          <div
            ...
            <div
              class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark"
              style="--bs-bg-opacity: 0.3">
              <h5 class="fw-bold">Blue Cushion</h5>
              <!-- <div>Programmer</div> -->
            </div>
          </div>
        </a>
        <a
          ...
          <div
            ...
            <div
              class="position-absolute bottom-0 w-100 p-2 p-lg-4 bg-dark"
              style="--bs-bg-opacity: 0.3">
              <h5 class="fw-bold">Table Cover</h5>
              <!-- <div>Programmer</div> -->
            </div>
          </div>
        </a>
