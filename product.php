  ...
  <body>
    ...
    <section class="py-5 min-vh-100">
      <div class="container">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a
                class="dropdown-item"
                href="javascript:void(0)"
                onclick="showCards('homeAccessories')"
                >Home Accessories</a
              >
            </li>
          </ul>
        ...
        <div class="row g-4">
          <!-- Clothing -->
          <div class="col-md-4 mb-lg-0 mt-0 card-group clothing">
            <div
          ...
          <div class="col-md-4 mb-lg-0 card-group clothing">
            <div
              class="card text-white border-0 justify-content-end position-relative"
              data-aos="zoom-in-up"
            >
          ...
          >
            ...
            >
              ...
              <div
                ...
                style="--bs-bg-opacity: 0.3"
              >
                <h5 class="fw-bold">King Bedsheet</h5>
                <!-- <div>Programmer</div> -->
              </div>
            </div>
          </a>
