            ...
            <div class="color-options d-flex gap-3 flex-wrap">
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Burgundy"
                  title="Burgundy" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Burgundy</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  src="img/bedding/double2.jpg"
              ...
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  src="img/bedding/double3.jpg"
                  data-color="Baby Blue"
                  data-image="img/bedding/double3.jpg"
                  data-zoom-image="img/bedding/double3.jpg"
                  alt="Baby Blue"
                  title="BabyBlue" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Baby Blue</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  src="img/bedding/double4.jpg"
                  data-color="Mauve"
                  data-image="img/bedding/double4.jpg"
                  data-zoom-image="img/bedding/double4.jpg"
                  alt="Mauve"
                  title="Mauve" />
                <small class="color-name mt-1 d-block text-tertiary-custom">Mauve
                </small>
              </div>
            </div>
            <div class="selected-color mt-3">
              <span class="text-tertiary-custom">Selected: </span>
              <span class="text-primary-custom fw-bold" id="selectedColor">Burgundy</span>
            </div>
          </div>
          ...
          <div class="size-section mb-4">
            ...
            <div class="size-options d-flex gap-2 flex-wrap">
              ...
              <div class="selected-size mt-5">
                ...
                <span class="text-primary-custom fw-bold" id="selectedSize">King</span>
              </div>
              <div class="mt-2">
