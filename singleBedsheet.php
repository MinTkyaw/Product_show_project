            ...
            <div class="color-options d-flex gap-3 flex-wrap">
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Ash Moss"
                  title="AshMoss"></img>
                <small class="color-name mt-1 d-block text-tertiary-custom">Ash Moss</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
              ...
              <div class="color-option-container text-center">
                <img
                  ...
                  alt="Seabreeze"
                  title="Seabreeze"></img>
                <small class="color-name mt-1 d-block text-tertiary-custom">Seabreeze</small>
              </div>
              <div class="color-option-container text-center">
                <img
                  class="color-option active"
                  ...
                  alt="Brick Ember"
                  title="BrickEmber"></img>
                <small class="color-name mt-1 d-block text-tertiary-custom">Brick Ember
                </small>
              </div>
            </div>
            <div class="selected-color mt-3">
              <span class="text-tertiary-custom">Selected: </span>
              <span class="text-primary-custom fw-bold" id="selectedColor">Ash Moss</span>
            </div>
          </div>
